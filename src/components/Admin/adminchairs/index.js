...
function Adminchairs() {
    ...
    const [{ chairsData, }, dispatch] = useStateValue();
    ...
    const deleteAction = (key) => {
        ...
        var adminchairs = chairsData
        var newadminchairs = adminchairs.filter((item, i) => item.key !== key)
        dispatch({
            type: 'CHAIRS',
            payload: newadminchairs,
        })
        ...
        if (data.title === "") {
            ...
            database
                ...
                .then(response => {
                    ...
                    alert("successfully upload chair post")
            ...
            <div className="section4__main">
                ...
                <TableContainer style={{ marginTop: "5%" }} component={Paper}>
                    <Table className={classes.table} aria-label="simple table">
                        ...
                        <TableBody>
                            {chairsData && chairsData.map((item, i) => (
