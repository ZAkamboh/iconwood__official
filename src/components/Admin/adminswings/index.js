...
function AdminSwings() {


    const [{ swingsData, }, dispatch] = useStateValue();
    ...
    const deleteAction = (key) => {
        ...
        var adminswings = swingsData
        var newadminswings = adminswings.filter((item, i) => item.key !== key)
        dispatch({
            type: 'SWINGS',
            payload: newadminswings,
        })
        ...
        if (data.title === "") {
            ...
            database
                ...
                .then(response => {
                    ...
                    alert("successfully upload swing post")
            ...
            <div className="section4__main">
                ...
                <TableContainer style={{ marginTop: "5%" }} component={Paper}>
                    <Table className={classes.table} aria-label="simple table">
                        ...
                        <TableBody>
                            {swingsData && swingsData.map((item, i) => (
