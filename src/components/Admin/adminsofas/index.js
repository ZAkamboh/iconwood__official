...
function AdminSofas() {
    ...
    const [{ sofasData, }, dispatch] = useStateValue();
    ...
    const deleteAction = (key) => {
        ...
        var adminsofas = sofasData
        var newadminsofas = adminsofas.filter((item, i) => item.key !== key)
        dispatch({
            type: 'SOFAS',
            payload: newadminsofas,
        })
        ...
        if (data.title === "") {
            ...
            database
                ...
                .then(response => {
                    ...
                    alert("successfully upload sofas post")
            ...
            <div className="section4__main">
                ...
                <TableContainer style={{ marginTop: "5%" }} component={Paper}>
                    <Table className={classes.table} aria-label="simple table">
                        ...
                        <TableBody>
                            {sofasData && sofasData.map((item, i) => (
