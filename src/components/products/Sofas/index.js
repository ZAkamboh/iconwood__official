...
function Sofas (props)  {
  const [{ sofasData, wishlist,users }, dispatch] = useStateValue()
          ...
          return (
            <Grid key={item} item xs={12} sm={3}>
              ...
              <div style={{display:"flex",padding:"5px"}}>
                  ...
                  <div >
                  <div  style={{height:"45vh", backgroundColor: "white",}}>
                 

                 <img
                 style={{width:"100%",height:"45vh",objectFit:"contain"}}
                     onClick={() => window.open(`${Server}/ViewProduct?productId=${item.key}`, '_blank')}
                   src={item.url}
